        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-3 space-y-8">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              {/* Manual Game Form */}
              <div>
                <h2 className="text-2xl font-bold text-white mb-6">Add Manually</h2>
                <GameForm onPgnChange={setCurrentPgn} />
              </div>

              {/* Import from PGN */}
              <div>
                <h2 className="text-2xl font-bold text-white mb-6">Import from PGN</h2>
                <PGNImport onPgnChange={setCurrentPgn} />
              </div>

              {/* Import from Lichess */}
              <div>
                <h2 className="text-2xl font-bold text-white mb-6">Import from Lichess</h2>
            ...
            {/* Stockfish Analysis */}
            <div>
              <h2 className="text-2xl font-bold text-white mb-6">Stockfish Analysis</h2>
          ...
          <div className="lg:col-span-1">
            <h2 className="text-2xl font-bold text-white mb-6">Game Preview</h2>
            {currentPgn ? (
